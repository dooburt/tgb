...
export const metadata = {
  title: "The Great Beyond - Explore, build and conquer - We're playing modded Minecraft servers: Steampunk, Dawncraft, BetterMC, Prominence II RPG, Cisco's Adventure and Cobblemon!",
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body className={`${outfit.variable} ${redHatDisplay.variable}`}>
        <TransparentHeader />
          {children}
        <Footer />
        </body>
