...
const HowToInstallSteampunk = () => {
  return (
    <section className="body-font bg-indigo-800 text-gray-600" id="get-started">
          ...
          <div className="mx-8 text-center">
            ...
            <div className="mx-auto flex lg:w-3/4 xl:w-2/4">
              ...
              <p className="text-left text-lg leading-relaxed text-gray-200 md:text-2xl">
                ...
                if you haven't already. Other players can help you. The admin can help you. The admin for Steampunk is{" "}
                <span className="text-purple-500">@theHSC</span>.
              </p>
            </div>
            <div className="mx-auto flex lg:w-3/4 xl:w-2/4">
            ...
            <div className="mx-auto flex lg:w-3/4 xl:w-2/4">
              ...
              <p className="text-left text-lg leading-relaxed text-gray-200 md:text-2xl">
                Install the{" "}
                <a href="https://www.curseforge.com/minecraft/modpacks/steam-punk" target="_blank" rel="noreferrer" className="text-yellow-200 underline">
                  Steampunk
                </a>{" "}
                modpack.
              </p>
            ...
            <div className="mx-auto flex lg:w-3/4 xl:w-2/4">
              ...
              <p className="text-left text-lg leading-relaxed text-gray-200 md:text-2xl">
                When Steampunk starts (and looks like the main Minecraft menu), hit Multiplayer and Add Server. Enter{" "}
                <span className="text-purple-400 ">The Great Beyond</span> as your server name and{" "}
                <span className="text-purple-400 ">steampunk.thegreatbeyond.org:25565</span> in the address box. You must add the port number. Connect!
              </p>
            </div>
            <div className="mx-auto flex lg:w-3/4 xl:w-2/4">
...
export default HowToInstallSteampunk;
