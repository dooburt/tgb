          ...
          <div className="mx-8 text-center">
            ...
            <div className="mx-auto flex lg:w-3/4 xl:w-2/4">
              ...
              <p className="text-left text-lg leading-relaxed text-gray-200 md:text-2xl">
                ...
                if you haven&apos;t already. Other players can help you. The admin can help you.
              </p>
            </div>
            <div className="mx-auto flex lg:w-3/4 xl:w-2/4">
            ...
            <div className="mx-auto flex lg:w-3/4 xl:w-2/4">
              ...
              <p className="text-left text-lg leading-relaxed text-gray-200 md:text-2xl">
                Install the{" "}
                <a href="https://www.curseforge.com/minecraft/modpacks/prominence-2-rpg" target="_blank" rel="noreferrer" className="text-yellow-200 underline">
                  Prominence II RPG
                </a>{" "}
                modpack.
              </p>
            ...
            <div className="mx-auto flex lg:w-3/4 xl:w-2/4">
              ...
              <p className="text-left text-lg leading-relaxed text-gray-200 md:text-2xl">
                When Prominence starts (and looks like the main Minecraft menu), hit Multiplayer and Add Server. Enter{" "}
                <span className="text-purple-400 ">The Great Beyond</span> as your server name and{" "}
                <span className="text-purple-400 ">prominence.thegreatbeyond.org</span> in the address box. Connect!
              </p>
            </div>
            <div className="mx-auto flex lg:w-3/4 xl:w-2/4">
              ...
              <p className="text-left text-lg leading-relaxed text-gray-200 md:text-2xl">
                ...
                <a href="https://rpg.prominence.wiki/" target="_blank" rel="noreferrer" className="text-yellow-200 underline">
                  Prominence RPG II wiki
                </a>{" "}
                for more information or ask in game or on our{" "}
                <a href="https://discord.gg/MXmcyScFEZ" target="_blank" rel="noreferrer" className="text-[#7289da] underline hover:text-[#677dcd]">
                  Discord
                </a>
                .
...
export default HowToInstallProminence;
