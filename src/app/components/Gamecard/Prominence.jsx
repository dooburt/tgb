        ...
        <section>
          <div className="px-8 pb-2">
            <div className="mb-20 text-center">
              ...
              <Link
                className="relative mx-auto mt-16 flex rounded border-0 bg-[#360939] px-8 py-4 pb-5 text-2xl text-white hover:bg-indigo-800 focus:outline-none lg:inline-flex"
                href={pack.url}
              >
...
export default GameCardProminence;
