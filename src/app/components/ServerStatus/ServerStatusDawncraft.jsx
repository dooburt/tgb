...
const ServerStatusDawncraft = () => {
  ...
  useInterval(async () => {
    setLoading(true);
    fetch("https://api.mcstatus.io/v2/status/java/dawncraft.thegreatbeyond.org:25503")
  ...
  const renderLoading = () => {
    return (
      <section className="body-font bg-slate-800 text-gray-200 min-h-[300px]">
  ...
  const renderError = () => {
    return (
      <section className="body-font bg-slate-800 text-gray-200">
  ...
  const renderOnlineTitle = () => {
    return (
      <span>
        THE GREAT BEYOND DAWNCRAFT SERVER IS <span className="text-green-400">ONLINE</span>
  ...
  const renderOfflineTitle = () => {
    return (
      <span>
        THE GREAT BEYOND DAWNCRAFT SERVER IS <span className="text-red-600">OFFLINE - RIP</span>
      </span>
    );
  };
  ...
  const renderMeta = () => {
    return (
      <div className="mt-8">
        <span className="text-sm text-slate-500">Last checked {dayjs().to(dayjs(serverData.retrievedAt))}</span>
      </div>
    );
  };

  return (
    <section className="body-font bg-slate-800 text-gray-200 min-h-[300px]" id="status">
      <div className="container mx-auto flex flex-col items-center px-5 py-24 md:w-2/3 md:flex-row">
        <div className="mb-6 flex w-full flex-col pr-0 text-center md:mb-0 md:w-auto md:pr-10 md:text-left">
...
export default ServerStatusDawncraft;
