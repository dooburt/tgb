...
const ServerStatusSteampunk = () => {
  ...
  useInterval(async () => {
    setLoading(true);
    fetch("https://api.mcstatus.io/v2/status/java/steampunk.thegreatbeyond.org")
  ...
  const renderOnlineTitle = () => {
    return (
      <span>
        THE GREAT BEYOND STEAMPUNK SERVER IS <span className="text-green-400">ONLINE</span>
  ...
  const renderOfflineTitle = () => {
    return (
      <span>
        THE GREAT BEYOND STEAMPUNK SERVER IS <span className="text-red-600">OFFLINE - RIP</span>
      </span>
    );
  };
...
export default ServerStatusSteampunk;
